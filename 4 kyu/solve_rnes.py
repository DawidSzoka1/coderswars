...
print(solve_runes("9928--?955=??883"))
...
#         elif runes[i] == '-':
#             count += 1
#         if runes[i] in avaible_digit:
#             avaible_digit.remove(runes[i])
#         if runes[0] in avaible_digit:
#             avaible_digit.remove(runes[0])
#     for j in avaible_digit:
#         puns = runes.replace('?', j)
#         before = puns.split('=')[0]
#         before_sign = before.split(sign)[0]
...
#         if after == '':
#             after = before.split(sign)[2]
#         if int(before_sign) == 0 or int(after) == 0:
#             pass
#         else:
#
#             if sign == '*':
